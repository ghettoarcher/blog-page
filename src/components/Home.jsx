  ...
  return (
    <div className="bg-slate-900">
      ...
      <div className="">
        <div className="container mx-auto px-5 pb-7">
          <div className="flex flex-row pt-7">
            <div className="flex flex-col justify-around bg-mountains-bg bg-cover bg-no-repeat w-full rounded-tl-xl">
              <div className="flex flex-row top-0  ml-14">
                ...
                <div className="flex flex-col">
                  <div className="text-white">By Benjamin Turner</div>
                  <div className="text-gray-400">Traveler</div>
                </div>
              </div>
              <div className="bottom-0 ml-14">
                <div className="text-sky-700 mb-6 text-sm font-bold">
                  DESTINATIONS
                </div>
                <div className="text-4xl text-white mb-11">
            ...
            <div className="flex flex-col">
              <div className="text-gray-900 text-sm font-bold bg-white py-5 px-6 border-b-2 rounded-tr-xl uppercase">
                Recommended for you
              </div>
              <RecommendedCategory
                color={"text-teal-400"}
                category={"food"}
                subtitle={"For Chicken-Fried Steak, Too Much Is Just Enough"}
              />
              <RecommendedCategory
                color={"text-blue-800"}
                category={"Cars"}
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex flex-row bg-white rounded-t-xl justify-between">
                    <div className="max-w-64 pt-8 pl-8 pb-2">
                      <div className="text-xs md:text-sm uppercase font-semibold text-blue-500">
                        Cars
                      </div>
                      <div className="text-sm md:text-2xl font-bold pt-5">
                ...
                <div className="flex flex-row gap-7">
                  <div className="flex flex-col self-start bg-white min-w-64 rounded-xl">
                    <img
                      ...
                      alt="cat"
                    />
                    <div className="flex flex-row font-semibold text-sm pt-4 px-6 pb-7 max-w-64 rounded-b-xl">
      ...
      <div className="flex flex-row bg-slate-200 pb-14">
        <div className="flex flex-col ml-7 "></div>
      </div>
      <div>
        <div className="bg-flower-bg pt-12 pb-14 flex flex-col items-center">
          <h1 className="text-white font-semibold text-center text-4xl pb-6">
        ...
        <div className="container mx-auto px-5">
          <div className="flex flex-row py-14">
            ...
            <div className="hidden sm:flex flex-col ml-7">
              <div className=" text-gray-900 font-semibold bg-white py-4 px-6 border-b-2 rounded-t-xl">
                Recommended for you
              </div>
              <RecommendedArticles />
              <div className="text-center text-sm bg-white pt-2 pb-3 font-semibold rounded-b-xl cursor-pointer">
                Read more
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-row pb-14">
              <div className="bg-boat-bg bg-cover bg-no-repeat flex flex-col items-center justify-between rounded-xl pt-11 pb-10 mr-7">
                <div className="flex flex-col items-center">
                  ...
                  <h1 className="text-3xl text-white font-semibold pt-7 px-12 mb-10">
                    Readers Choice winners: Your wine country favorites
                  </h1>
                  <Button text={"Watch photos"} />
                </div>
                <div className="flex">
                  <img src="/src/assets/icons/Pagination.svg" alt="" />
                </div>
              </div>
              <div className="flex flex-col rounded-xl">
                <div className="flex flex-row bg-gray-100 rounded-xl max-w-3xl mx-auto">
                  <div className="py-6 pl-9 flex-1">
                    ...
                    <p className="text-gray-600 max-w-52 mb-6">
                      Try to understand the culture of the company where you
                      want to work and be authentic in your interview, experts
                      emphasize.
                    </p>
                    <Button text={"Read more"} />
                  </div>
                  <div className="flex-shrink-0 lg:max-w-sm mt-4 mr-7">
                    <img
                      className=""
                      src="/src/assets/img/image-169.svg"
                      alt="Interview tips"
                    />
                  </div>
                </div>
