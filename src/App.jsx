...
import ColumnsAside from "./components/ColumnsAside"
      ...
      <header>
          <div className="container mx-auto px-5">
              <div className="flex flex-row justify-between border-b-2  ">
                      <div className="grid  grid-cols-2">
                          ...
                          <div className="flex flex-row pt-4 ml-6">
                              ...
                              <div className="pe-6 text-gray-500 text-base">Search</div>
                          </div>
                      </div>
              ...
              <div className="flex flex-row items-center justify-between pl-7">
                  ...
                  <div><img src="/src/assets//icons/logo.svg" alt=""/></div>
                  <div className="flex flex-row">
                      <Date/>
                      <Weather/>
                      ...
                      <div className="flex flex-col rounded-xl">
                          <div className="flex flex-row bg-gray-100 rounded-xl max-w-3xl mx-auto">
                              <div className="p-6 flex-1">
                                  ...
                                  <p className="text-gray-600 mb-6">Try to understand the culture of the company where you want to work and be authentic in your interview, experts emphasize.</p>
                                  <Button text={"Read more"}/>
                              </div>
                              <div className="flex-shrink-0 lg:max-w-sm mt-4 mr-7">
                                  <img className="w-full h-full object-cover" src="/src/assets/img/image-169.svg" alt="Interview tips"/>
                              </div>
                          </div>
